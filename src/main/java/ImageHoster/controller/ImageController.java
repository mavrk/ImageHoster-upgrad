...
public class ImageController {
    ...
    //First receive the dynamic parameter in the incoming request URL in an integer variable 'id' and also the Model type object
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession httpSession, RedirectAttributes redirectAttributes) {
        Image image = imageService.getImage(imageId);
		User user = (User) httpSession.getAttribute("loggeduser");

		if(isOwner(image, user)) {
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, HttpSession httpSession, RedirectAttributes redirectAttributes) {
	    Image image = imageService.getImage(imageId);
	    User user = (User) httpSession.getAttribute("loggeduser");
    ...
    //This method receives image and user data
	//And checks if the user is an owner for the image
	//Returns true/ false
    private boolean isOwner(Image image, User user) {
